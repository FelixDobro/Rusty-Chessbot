...
impl Board {
    ...
    pub fn eval(&self) -> i16 {
        (self.game_phase * self.eval_mg + (24 - self.game_phase) * self.eval_eg) / 24
    }
...
pub static MG: LazyLock<Box<[[i16; 64]; 12]>> = LazyLock::new(|| {
    ...
    table[Pawn.index() + WhiteSide::OFFSET] = [
    ...
    table[Knight.index() + WhiteSide::OFFSET] = [
    ...
    table[Bishop.index() + WhiteSide::OFFSET] = [
    ...
    table[Rook.index() + WhiteSide::OFFSET] = [
    ...
    table[Queen.index() + WhiteSide::OFFSET] = [
    ...
    table[King.index() + WhiteSide::OFFSET] = [
    ...
    for piece in 0..6 {
        for sq in 0..64 {
            table[BlackSide::OFFSET + piece][sq] = table[WhiteSide::OFFSET + piece][flip(sq)]
        }
