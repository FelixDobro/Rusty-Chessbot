...
fn main() -> Result<(), Box<dyn Error>> {
    ...
    let m = Move::new(Square::A2 as u16, Square::A4 as u16, 1);
    let m2 = Move::new(Square::A7 as u16, Square::A6 as u16, 0);
    let m3 = Move::new(Square::E2 as u16, Square::E4 as u16, 0);
    ...
    let pseudos = board.generate_pseudolegals();
    pseudos.print_list();
    board.print();
